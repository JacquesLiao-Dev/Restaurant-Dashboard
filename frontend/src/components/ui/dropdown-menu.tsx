...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    checked={checked}
    className={cn(dropdownMenuItemStyles, "pl-9", className)}
    {...props}
  >
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-3 py-2 text-caption font-semibold uppercase tracking-[0.18em] text-muted-foreground", inset ? "pl-8" : "", className)}
    {...props}
  />
));
...
function DropdownMenuShortcut({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
  return <span className={cn("ml-auto pl-4 text-caption text-muted-foreground", className)} {...props} />;
}
