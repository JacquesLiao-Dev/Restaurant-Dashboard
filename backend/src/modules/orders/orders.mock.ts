import type { Order, OrderLineItem, OrderStatus } from "./orders.types";
...
function createOrderLine(item: CatalogItem, quantity: number): OrderLineItem {
  return {
    menuItemId: item.id,
    name: item.name,
...
function createSeedOrder(input: {
  id: string;
  orderNumber: number;
  customerName: string;
  status: OrderStatus;
...
export function createMockOrders(): Order[] {
  return [
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.futomaki, 1), createOrderLine(catalog.biere, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.plateauMaki, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.makiSaumon, 2), createOrderLine(catalog.glace, 1), createOrderLine(catalog.cafe, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.rolls, 1), createOrderLine(catalog.biere, 2)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.futomaki, 2)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.makiSaumon, 1), createOrderLine(catalog.nem, 1), createOrderLine(catalog.cafe, 2)],
    }),
    createSeedOrder({
    ...
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.poulpe, 1), createOrderLine(catalog.biere, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.rolls, 1), createOrderLine(catalog.glace, 2)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.futomaki, 1), createOrderLine(catalog.makiSaumon, 1), createOrderLine(catalog.cafe, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.plateauMaki, 1), createOrderLine(catalog.biere, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.nem, 2), createOrderLine(catalog.cafe, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.rolls, 2)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.makiSaumon, 3), createOrderLine(catalog.biere, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.plateauMaki, 1), createOrderLine(catalog.glace, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.futomaki, 2), createOrderLine(catalog.makiSaumon, 2)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.rolls, 1), createOrderLine(catalog.biere, 2), createOrderLine(catalog.glace, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.plateauMaki, 1), createOrderLine(catalog.cafe, 2), createOrderLine(catalog.nem, 1)],
    }),
    createSeedOrder({
      ...
      items: [createOrderLine(catalog.futomaki, 1), createOrderLine(catalog.poulpe, 2)],
    }),
